...
def get_args():
    ...
    # parser.add_argument('--config', default='configs/Extreme_Rotation/config_streatlearn.yaml', type=str,
    #                     help='The configuration file.')
    # parser.add_argument('--config', default='configs/Extreme_Rotation/config_cambridge.yaml', type=str,
    #                     help='The configuration file.')
    # parser.add_argument('--config', default='configs/Extreme_Rotation/config_squares.yaml', type=str,
    #                     help='The configuration file.')
    # parser.add_argument('--config', default='configs/PointVit/config_streatlearn.yaml', type=str,
    #                     help='The configuration file.')
    # parser.add_argument('--config', default='configs/PointVit/config_cambridge.yaml', type=str,
    #                     help='The configuration file.')
    # parser.add_argument('--config', default='configs/SIFT/config_cambridge.yaml', type=str,
    #                     help='The configuration file.')
    ...
    #                     help='The configuration file.')
    # parser.add_argument('--config', default='configs/LoFTR/config_squares.yaml', type=str,
    #                     help='The configuration file.')
    ...
    # parser.add_argument('--pretrained',default='pretrained/streetlearn_cv_distribution.pt',type=str,
